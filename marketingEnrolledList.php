...
<html lang="en">
  <head>
    ...
    <title>Marketing Enrolled List </title>
  ...
  <div id = "content">
        ...
        <div class = "filterPosted">
            ...
            <div class="checkbox-container">
                <input <?php echo ($freqPosted[1] == 1) ? 'checked' : ''; ?> 
                       ...
                       name="posted[]" 
                       onchange="submitForm()">
                <label class="checkboxLabel" for="checkboxPosted">Posted on Both</label>
            </div>
    ...
    <div id = "contentStudents">
        <h1 style = "float: left;"> Marketing Enrolled List</h1>
        <br>
        <br>
        <br>
        <br>
        ...
        <ol id = "students-list" class="list-group list-group-numbered">
            <?php
                $sqlApplication = "SELECT 
                    ...
                    aps.postedEnrolledStatus AS postedEnrolledStatus
                FROM 
                ...
                WHERE 
                    ...
                    AND aps.appStatus = " . "'Enrolled'" . "
                    AND aps.postedEnrolledStatus IN" . $postedString . "
              ...
              ?>
                <div class = "student">
                    <li class="list-group-item d-flex justify-content-between align-items-start">
                        <div class="ms-2 me-auto">
                            ...
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <span class="badge <?php 
                                    switch($row['postedEnrolledStatus']) {
                                        case 0:
                                            echo 'not-posted';
                                            break;
                                        case 1:
                                ...
                                ?>">
                                    <?php echo getTextStatus($row['postedEnrolledStatus']); ?>
                                </span>
                            </div>
                        </div>

                        <?php 
                        $urlApplication = 'postApplicationEnrolled.php?applicationId=' . $row['applicationId'];
                        $urlUnpost = 'unpostApplicationEnrolled.php?applicationId=' . $row['applicationId'];
                        if ($row['postedEnrolledStatus'] == 0) { ?>
                        ...
                        <?php } elseif ($row['postedEnrolledStatus'] == 2) { ?>
                            <div class="d-flex gap-2">
                                <a onclick="confirmPost('<?php echo $urlApplication; ?>&platform=3')">
                                    <button type="button" class="btn btn-primary" style="background: #1877F2;">
                                        <i class="fab fa-facebook mr-2"></i> Post on Facebook
                        ...
                        <?php } elseif ($row['postedEnrolledStatus'] == 3) { ?>
                            <div class="d-flex gap-2">
                                <a onclick="confirmPost('<?php echo $urlApplication; ?>&platform=2')">
                                    <button type="button" class="btn btn-primary" style="background: #E1306C;">
                                        <i class="fab fa-instagram mr-2"></i> Post on Instagram
                        ...
                        <?php } elseif ($row['postedEnrolledStatus'] == 1 || $row['postedEnrolledStatus'] == 4) { ?>
                            <div class="d-flex gap-2">
                                <a onclick="confirmUnpost('<?php echo $urlUnpost; ?>&platform=2')">
                                    <button type="button" class="btn btn-primary" style="background: #E1306C;">
                                        <i class="fas fa-undo mr-2"></i> Unpost from Instagram
    ...
    <script>
        function confirmPost(link) {
            const userConfirmed = confirm("Are you sure you want to mark this application as posted?");
            if (userConfirmed) {
        ...
        function confirmUnpost(link) {
            const userConfirmed = confirm("Are you sure you want to mark this application as unposted?");
            if (userConfirmed) {
                window.location.href = link;
            } else {
                alert("Action canceled.");
