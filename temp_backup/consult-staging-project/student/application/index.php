...
<html lang="en">
  ...
  <div id = "content">
    ...
    ?>
    <p class = "student-info"> <span class = "title-info"> Applying Student: </span> <a href = "../"><?php echo $dataStudent['name']; ?> </a> </p>
    <p class = "student-info"> <span class = "title-info"> Class: </span> <?php echo $dataStudent['grade']; ?> </p>
    ...
    <p class = "student-info"> <span class = "title-info"> Univeristy name: </span> <?php echo $universityName; ?> </p>
