    ...
    if($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($meetingDateTime > $currentDateTime) {
            ...
            if ($futureMeetingsCount >= 2) {
                ...
                $sqlAddMeeting = "INSERT INTO meetings (`studentId`, `consultantId`, `studentName`, `studentSchool`, `consultantName`, `meetingDate`, `meetingNotes`, `meetingTopic`, `meetingActivities`) VALUES ('$studentId', '$consultantId', '$studentName', '$studentSchool', '$consultantName','$meetingDate', '$meetingNotes', '$meetingTopic', '$stringActivities')";
