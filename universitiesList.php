  ...
  <div id="content">
    <div id="contentStudents">
        <div class="filter-buttons">
            <a href="<?php echo $base_url; ?>universitiesList.php?university-filter=0">
                <button class="btn btn-primary button1">All Universities</button>
            </a>
            <a href="<?php echo $base_url; ?>universitiesList.php?university-filter=1">
                <button class="btn btn-primary button2">Commissionable Universities</button>
            </a>
            <a href="<?php echo $base_url; ?>universitiesList.php?university-filter=2">
                <button class="btn btn-primary button3">Non-Commissionable Universities</button>
            </a>
        </div>
        ...
        <div class="search-container">
            <input type="text" id="search-bar-name" onkeyup="searchFunction()" placeholder="Search by university name..." title="Type in a name">
            <input type="text" id="search-bar-country" onkeyup="searchFunction()" placeholder="Search by country..." title="Type in a country">
        </div>

        <p>There are <span class="search-count"><?php echo $noUniversities; ?></span> universities in your search</p>
