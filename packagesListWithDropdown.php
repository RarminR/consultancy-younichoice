  ...
  <div class="container-fluid mt-5">
        ...
        <div class="selector-container">
            ...
            <form method="POST" action="">
                <div class="row">
                    ...
                    <?php if ($selectedGrade && $selectedPackageId): ?>
                    <div class="col-md-4">
                        <div class="form-group">
                                ...
                                <div class="package-item list-group-item d-flex justify-content-between align-items-center">
                                    <div class="d-flex align-items-center">
                                        <div class="package-name">
                                            ...
                                            <span class="package-type-badge"><?php echo $package['packageType']; ?></span>
                                        </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            if (document.getElementById('package') && document.getElementById('package').value) {
                updatePackageId();
            }
        });
